...
codebase's code. It's a real cost of the M5 decimal128-for-precision
...
**The optimization did not improve the end-to-end achieved throughput,
and within this small sample, was even slightly lower.** This is
...
end-to-end number bounded by something else entirely. It's a genuinely
